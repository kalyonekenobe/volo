...
const GoogleOAuthButton: FC<GoogleOAuthButtonProps> = ({ isLogin, setError }) => {
  const redirectToGoogleAuthPage = () => {
  ...
  return (
    <div>
      <button className='secondary-gray-button w-full' onClick={redirectToGoogleAuthPage}>
