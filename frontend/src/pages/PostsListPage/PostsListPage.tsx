...
const PostsListPage: FC = () => {
  ...
  const { posts, fetchAllPosts, setPostsInStorage } = usePostStorage();
    ...
    <div className='bg-gray-50 h-full relative'>
      ...
      <main className='min-h-screen p-6 sm:ml-64'>
        <div className='mb-5 flex justify-between'>
          ...
          <div>
            <button onClick={() => navigate(AppRoutes.PostsCreate)} className='primary-button'>Create a new post</button>
          </div>
        </div>
